Shader "Universal Render Pipeline/Unlit Shadowed With Definition"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag(Varyings input) : SV_Target
            {
                ...
                float facing = clamp((dot(input.normalWS, float3(0,1,1)) + 1.5) * 0.5, 0, 1);
                color.rgb = lerp(float3(0, 0, 0), color.rgb, facing);
#endif
